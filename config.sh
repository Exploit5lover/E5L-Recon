...
RUN_CHECK_SUBDOMAIN_TAKEOVER=true #for subdomain takeover check
RUN_FUZZ_PARAMETERS=true # Enable parameter fuzzing
RUN_WAF_DETECTION=true # Enable WAF detection
RUN_SCREENSHOT=false # Enable screenshot capturing
